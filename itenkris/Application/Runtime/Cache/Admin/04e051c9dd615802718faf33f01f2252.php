...
<div class="main-div">
    <form name="main_form" method="POST" action="/index.php/Admin/Employ/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
				    <textarea id="kr" name="kr"></textarea>
                </td>
            </tr>
            <tr>
                <td class="label">任职条件：</td>
                <td>
                    <textarea id="eq" name="eq"></textarea>
                </td>
            </tr>
            <tr>
