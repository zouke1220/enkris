...
<div class="main-div">
    <form name="main_form" method="POST" action="/index.php/Admin/Intro/edit/id/2.html" enctype="multipart/form-data" >
    	<input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
        <table cellspacing="1" cellpadding="3" width="100%">
		     <tr>
                <td class="label">公司logo：</td>
                <td>
				    <img src="/Public/Uploads/<?php echo $data['logo']?>" /><br />
            ...
            <tr>
                ...
                <td>
                    <textarea id="cintro" name="cintro"><?php echo $data['cintro']; ?></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea id="gintro" name="gintro"><?php echo $data['gintro']; ?></textarea>
                </td>
            </tr>
            <tr>
