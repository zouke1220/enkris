...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            <li class="explode" key="nav" name="menu">
            导航管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Category/lst'); ?>" target="main-frame">分类列表</a></li>
                </ul>
            </li>			
			<li class="explode" key="news" name="menu">
            新闻管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('News/lst'); ?>" target="main-frame">新闻列表</a></li>
                </ul>
            </li>
            <li class="explode" key="Goods" name="menu">
            产品管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Goods/lst'); ?>" target="main-frame">产品列表</a></li>
                </ul>
            </li>
			<li class="explode" key="employ" name="menu">
            招聘管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Employ/lst'); ?>" target="main-frame">招聘信息列表</a></li>
                </ul>
            </li>
			<li class="explode" key="contact" name="menu">
            综合信息
                <ul>
				    <li class="menu-item"><a href="<?php echo U('Intro/lst'); ?>" target="main-frame">简介</a></li>
					<li class="menu-item"><a href="<?php echo U('About/lst'); ?>" target="main-frame">关于我们</a></li>
                    <li class="menu-item"><a href="<?php echo U('Contact/lst'); ?>" target="main-frame">联系我们</a></li>
                </ul>
            </li>
			<li class="explode" key="Admin" name="menu">
            管理员管理
                <ul>
