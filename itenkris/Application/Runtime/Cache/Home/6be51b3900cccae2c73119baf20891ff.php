...
<div id="Contact">
	...
	<div id="news-header">
        <div id="news-logo"><img src="/Public/Home/img/news-logo.png"/></div>
        <div id="lr"><h2><span class="left">Know more</span><span class="right">&nbsp;about Enkris</span></h2></div>
    </div>	
    <div id="news">
	    <?php foreach($pdata as $k=>$v): $k++; ?>
	    <div id="new-1">            
            <div id="news-pic">
	            <img src="/Public/Home/img/news<?php echo $k;?>.png" />
			</div>
	        <div id="news-title">
			    <h5><a href="<?php echo U('News/newsview?id='.$v['id']);?>" class="s22"><?php echo $v['news_title']?></a></h5>
			</div>
			<div id="news-content">
